import numpy as np
# from irl_seqGAN import SEQ_LENGTH
# SEQ_LENGTH=12
...
class Gen_Data_loader():
    ...
    def create_batches(self, data_file):
        ...
        with open(data_file, 'r') as f:
            ...
            # print("token_stream   = ", self.token_stream)
...
class Dis_dataloader():
    ...
    def load_train_data(self, positive_file, negative_file):
        ...
        self.neg_sentences = self.neg_sentences[:self.num_batch * self.batch_size]
        # print(len(self.pos_sentences), len(self.neg_sentences),self.batch_size,self.num_batch," --debug out 2")
